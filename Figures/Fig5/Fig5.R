...
matrix_data$gene_id <- case_when(
  matrix_data$gene_id == "NonamEVm002966t3" ~ "Ancestral CENP-E Paralog",
  matrix_data$gene_id == "NonamEVm000093t1" ~ "Truncated Neo-Y Transcript",
...
plot_len_ancestral <- generate_length_plot("NonamEVm002966t3", length_ancestral, len_colors["Ancestral"])
plot_len_neoy      <- generate_length_plot("NonamEVm000093t1", length_neoy, len_colors["NeoY"])

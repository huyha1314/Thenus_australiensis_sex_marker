...
## 2. Genome survey using kmer distribution generated by the Illumina reads with KMC (v3.2.1) and GenomeScope (V2.0)
```bash
ATA_DIR="data/merge"
...
### 3.3 RNA scaffolding of Draft Genome results using short-read RNA-seq with HISAT2 (v2.2.1) and Rascaf (v20180710)
```bash
